  ...
  return (
    <div className="max-w-lg mx-auto flex flex-col w-full bg-[#f8f9fa] min-h-screen z-50 fixed inset-0 md:relative md:inset-auto">
      ...
      <header className="flex items-center py-5 px-4 relative mt-2 bg-[#f8f9fa]">
        ...
        <h1 className="flex-1 text-center text-[19px] font-semibold text-gray-900 pr-10">Report Comment</h1>
      </header>

      {/* Content */}
      <div className="px-5 mt-4">
        <h2 className="text-[15px] font-medium text-gray-700 mb-5 ml-1">Why are you reporting this comment?</h2>
